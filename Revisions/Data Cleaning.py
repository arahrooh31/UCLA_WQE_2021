...
data2 = pd.read_csv('combined_HF_data.csv')


cleaned_HF_data = data2
scaler = MinMaxScaler()
scaled_cleaned_HF_data = scaler.fit_transform(cleaned_HF_data)
scaled_cleaned_HF_data_df = pd.DataFrame(scaled_cleaned_HF_data, columns = cleaned_HF_data.columns)
print(scaled_cleaned_HF_data_df.head)
scaled_cleaned_HF_data_df.to_csv(r'scaled_cleaned_HF_data.csv', index=False)
