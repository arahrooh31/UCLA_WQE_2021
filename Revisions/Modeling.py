...
dataset = pd.read_csv('scaled_cleaned_heart_disease_data.csv', header = 0)

#Splitting the Data
X = pd.read_csv('scaled_cleaned_heart_disease_data.csv', usecols = range(1,188), header = 0)
Y = pd.read_csv('scaled_cleaned_heart_disease_data.csv', usecols = range(188,198), header = 0)
...
alpha_evaluation_score(y_test, ET_pred)
...
data3 = pd.read_csv("scaled_cleaned_HF_data.csv", header = 0)


#Splitting the Data
X2 = pd.read_csv('scaled_cleaned_HF_data.csv', usecols = range(0,11), header = 0)
Y2 = pd.read_csv('scaled_cleaned_HF_data.csv', usecols = range(11,12), header = 0)
print(X2.head)
print(Y2.head)
...
RF_model = RF_model.fit(X2, Y2)
RF_pred = RF_model.predict(Y2)



ET2 = ExtraTreeClassifier(random_state=0)
ET_model2 = ET2.fit(X_train2, y_train2)
ET2_pred = ET_model2.predict(X_test2)
accuracy_score(y_test2, ET2_pred)




ET_pred = ET_model.predict(Y2)